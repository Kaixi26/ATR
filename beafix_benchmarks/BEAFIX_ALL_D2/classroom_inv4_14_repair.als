//Line and OP: Line 93 <QTOR> 
//ORIGINAL: (all x : one Person  | AND[(x !in Student), (x !in Teacher)])
//MUTATION: (no x : one Person  | AND[(x !in Student), (x !in Teacher)])
...
pred inv4 []{
	no x : Person | (x !in Student) && (x !in Teacher)
}
