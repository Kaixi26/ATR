//Line and OP: Line 746 <JER> 
//ORIGINAL: (t . (Class . Groups))
//MUTATION: (Person . (Class . Groups))
//Line and OP: Line 746 <JEE> 
//ORIGINAL: (Class . Groups)
//MUTATION: ((t . Teaches) . Groups)
...
pred inv12 []{
	all t : Teacher | some g : Group | g in (Person . ((t . Teaches) . Groups))
}
