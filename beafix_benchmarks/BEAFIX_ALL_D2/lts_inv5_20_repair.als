//Line and OP: Line 214 <QTOR> 
//ORIGINAL: (some e : one Event  | (some (e . (s1 . trans)) => some (e . (s2 . trans))))
//MUTATION: (all e : one Event  | (some (e . (s1 . trans)) => some (e . (s2 . trans))))
...
pred inv5 []{
	all s1, s2 : State | all e : Event | (some (e . (s1 . trans))) => (some (e . (s2 . trans)))
}
