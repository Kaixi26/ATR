//Line and OP: Line 130 <QTOR> 
//ORIGINAL: (all t : one Teacher  | (t in Group))
//MUTATION: (some t : one Teacher  | (t in Group))
//Line and OP: Line 130 <JEE> 
//ORIGINAL: Group
...
pred inv5 []{
	some t : Teacher | t in (Teaches . Class)
}
