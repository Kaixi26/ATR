//Line and OP: Line 71 <CUOI> 
//ORIGINAL: ! (Person in (Student & Teacher))
//MUTATION: ! ! (Person in (Student & Teacher))
//Line and OP: Line 71 <SSE> 
//ORIGINAL: (Student & Teacher)
//MUTATION: ((Student & Teacher) + Person)
...
pred inv3 []{
	! (! (Person in ((Student & Teacher) + Person)))
}
