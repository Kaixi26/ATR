//Line and OP: Line 751 <RUOI> 
//ORIGINAL: (Groups . Group)
//MUTATION: ~ (Groups . Group)
//Line and OP: Line 751 <JEE> 
//ORIGINAL: (~ (Groups . Group) . t)
//MUTATION: (~ (Groups . Group) . (t . Teaches))
...
pred inv12 []{
	all t : Teacher | some ((~ (Groups . Group)) . (t . Teaches))
}
