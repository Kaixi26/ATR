//Line and OP: Line 55 <COR> 
//ORIGINAL: AND[(p in Student), (p !in Teacher)]
//MUTATION: OR[(p in Student), (p !in Teacher)]
...
pred inv3 []{
	all p : Person | ((p in Student) || (p !in Teacher)) || ((p in Teacher) && (p !in Student))
}
