//Line and OP: Line 53 <COR> 
//ORIGINAL: ((Person in Teacher) <=> ! (Person in Student))
//MUTATION: OR[(Person in Teacher), ! (Person in Student)]
...
pred inv3 []{
	(Teacher in Teacher) || (! (Person in Student))
}
