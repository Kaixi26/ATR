//Line and OP: Line 206 <RUOI> 
//ORIGINAL: (s . trans)
//MUTATION: ~ (s . trans)
//Line and OP: Line 206 <NESE> 
//ORIGINAL: some (~ (s . trans) . e)
//MUTATION: (some (~ (s . trans) . e) => some (~ (s . trans) . e))
//Line and OP: Line 206 <JER> 
//ORIGINAL: (s . trans)
...
pred inv5 []{
	all s : State, e : Event | (some ((~ (State . trans)) . e)) => (some ((~ (s . trans)) . e))
}
