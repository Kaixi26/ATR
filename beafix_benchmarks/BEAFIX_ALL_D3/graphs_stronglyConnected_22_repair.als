//Line and OP: Line 349 <COR> 
//ORIGINAL: OR[((Node - n) in (n . ^ adj)), ((Node - n) in (n . ^ ~ adj))]
//MUTATION: AND[((Node - n) in (n . ^ adj)), ((Node - n) in (n . ^ ~ adj))]
...
pred stonglyConnected []{
	all n : Node | ((Node - n) in (n . (^ adj))) && ((Node - n) in (n . (^ (~ adj))))
}
