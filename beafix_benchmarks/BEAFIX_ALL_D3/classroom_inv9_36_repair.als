//Line and OP: Line 352 <CUOI> 
//ORIGINAL: ((t1 -> t2) !in Teaches)
//MUTATION: ! ((t1 -> t2) !in Teaches)
//Line and OP: Line 352 <RUOI> 
//ORIGINAL: Teaches
//MUTATION: * Teaches
...
pred inv9 []{
	all t1, t2 : Teacher, c : Class | (((t1 -> c) in Teaches) && ((t2 -> c) in Teaches)) => (! ((t1 -> t2) !in (* Teaches)))
}
